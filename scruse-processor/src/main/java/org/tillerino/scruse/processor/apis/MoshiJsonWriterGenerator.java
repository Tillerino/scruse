...
public class MoshiJsonWriterGenerator extends AbstractWriterGenerator<MoshiJsonWriterGenerator> {
    private final VariableElement writerVariable;

    public MoshiJsonWriterGenerator(
    ...
    public MoshiJsonWriterGenerator(
            ...
            MoshiJsonWriterGenerator parent,
            LHS lhs,
            RHS rhs,
            String propertyName,
