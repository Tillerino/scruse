...
public class JacksonJsonNodeReaderGenerator extends AbstractReaderGenerator<JacksonJsonNodeReaderGenerator> {
    ...
    public JacksonJsonNodeReaderGenerator(
            ...
            LHS lhs,
            JacksonJsonNodeReaderGenerator parent,
    ...
    protected void iterateOverFields() {
        ...
        code.beginControlFlow(
                "for ($T<String, $T> $L : ($T<$T<String, $T>>) () -> $L.fields())",
                Map.Entry.class,
                jsonNode(),
                entryVar,
                Iterable.class,
    ...
    protected void readDiscriminator(String propertyName) {
        lhs.assign(
                ...
                JacksonJsonNodeReaderHelper.class,
                propertyName,
    ...
    protected void throwUnexpected(String expected) {
        code.addStatement(
                "throw new $T($S + $L.getClass().getSimpleName() + $S)",
                IOException.class,
    ...
    @Override
    protected JacksonJsonNodeReaderGenerator nest(
            TypeMirror type, @Nullable String propertyName, LHS lhs, boolean stackRelevantType) {
        return new JacksonJsonNodeReaderGenerator(
                prototype,
                utils,
    ...
    private String nodeVar() {
        return nodeVarOverride != null
                ? nodeVarOverride
                : parent != null
                        ? parent.nodeVar()
                        : parserVariable.getSimpleName().toString();
    }
}
