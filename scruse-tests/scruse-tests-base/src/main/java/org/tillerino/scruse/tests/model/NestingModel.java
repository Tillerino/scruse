...
public class NestingModel {
	public record OuterRecord(Double[] doubleArray, List<Double> doubleList, Map<String, Double> doubleMap, InnerRecord innerRecord, InnerFields innerFields, InnerAccessors innerAccessors) {
	}
