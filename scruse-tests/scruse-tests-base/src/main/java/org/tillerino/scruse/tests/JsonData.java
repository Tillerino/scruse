...
public class JsonData {
    ...
    public static final String[] CHARS = {"\"a\"", "\"A\"", "\"ö\"", "\"Ö\"", "\"\\u0000\"", "\"\\uFFFF\""};
    ...
    public static final String[] BOOLEAN_ARRAYS = {
        "null", "[]", "[true]", "[false]", "[ false,    true, false  ]", asArray(BOOLEANS)
    };
    public static final String[] BYTE_ARRAYS = {
        "null", "[]", "[1]", "[0]", "[-1]", "[127]", "[-128]", asArray(BYTES), "\"\"", "\"MTIzNA==\"",
    };
    public static final String[] SHORT_ARRAYS = {
        "null", "[]", "[1]", "[0]", "[-1]", "[32767]", "[-32768]", asArray(SHORTS)
    };
    public static final String[] INT_ARRAYS = {
        "null", "[]", "[1]", "[0]", "[-1]", "[2147483647]", "[-2147483648]", asArray(INTS)
    };
    public static final String[] LONG_ARRAYS = {
        "null", "[]", "[1]", "[0]", "[-1]", "[9223372036854775807]", "[-9223372036854775808]", asArray(LONGS)
    };
    public static final String[] FLOAT_ARRAYS = {
        "null", "[]", "[1.0]", "[0.0]", "[-1.0]", "[3.4028235E38]", "[-3.4028235E38]", asArray(FLOATS)
    };
    ...
    public static final String[] BOXED_BOOLEAN_ARRAYS = {
        "null", "[]", "[null]", "[true]", "[false]", asArray(BOXED_BOOLEANS)
    };
    public static final String[] BOXED_BYTE_ARRAYS = {
        "null", "[]", "[null]", "[1]", "[0]", "[-1]", "[127]", "[-128]", asArray(BOXED_BYTES)
    };
    public static final String[] BOXED_SHORT_ARRAYS = {
        "null", "[]", "[null]", "[1]", "[0]", "[-1]", "[32767]", "[-32768]", asArray(BOXED_SHORTS)
    };
    public static final String[] BOXED_INT_ARRAYS = {
        "null", "[]", "[null]", "[1]", "[0]", "[-1]", "[2147483647]", "[-2147483648]", asArray(BOXED_INTEGERS)
    };
    ...
    public static final String[] BOXED_FLOAT_ARRAYS = {
        "null", "[]", "[null]", "[1.0]", "[0.0]", "[-1.0]", "[3.4028235E38]", "[-3.4028235E38]", asArray(BOXED_FLOATS)
    };
    ...
    public static final String[] STRING_ARRAYS = {
        "null", "[]", "[null]", "[\"abc\"]", asArray(STRINGS),
    };
    public static final String[] ENUM_ARRAYS = {
        "null", "[]", "[null]", "[\"SOME_VALUE\"]", "[\"ANOTHER_VALUE\"]", asArray(ENUMS),
    };

    // Scalar maps
    public static final String[] STRING_BOOLEAN_MAPS = {
        "null", "{ }", "{\"a\": null}", "{\"a\": true}", "{\"a\": false}", "{\"a\": true, \"b\": null, \"c\": false}",
    };
    public static final String[] STRING_BYTE_MAPS = {
        "null", "{ }", "{\"a\": null}", "{\"a\": 0}", "{\"a\": 1}", "{\"a\": 0, \"b\": null, \"c\": 2}",
    };
    ...
    public static final String[] STRING_CHAR_MAPS = {
        "null", "{ }", "{\"a\": null}", "{\"a\": \"a\"}", "{\"a\": \"b\"}", "{\"a\": \"a\", \"b\": null, \"c\": \"c\"}",
    };
