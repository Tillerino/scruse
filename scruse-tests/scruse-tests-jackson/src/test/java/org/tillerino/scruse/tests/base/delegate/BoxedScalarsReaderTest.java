...
public class BoxedScalarsReaderTest {
    ...
    void testBoxedBoolean() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedBooleanX").calls("readPrimitiveBooleanX");
    }
    ...
    void testBoxedByte() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedByteX").calls("readPrimitiveByteX");
    }
    ...
    void testBoxedShort() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedShortX").calls("readPrimitiveShortX");
    }
    ...
    void testBoxedInt() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedIntX").calls("readPrimitiveIntX");
    }
    ...
    void testBoxedLong() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedLongX").calls("readPrimitiveLongX");
    }
    ...
    void testBoxedChar() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedCharX").calls("readPrimitiveCharX");
    }
    ...
    void testBoxedFloat() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedFloatX").calls("readPrimitiveFloatX");
    }
    ...
    void testBoxedDouble() throws Exception {
        ...
        assertThatCode(BoxedScalarsReaderImpl.class).method("readBoxedDoubleX").calls("readPrimitiveDoubleX");
    }
}
