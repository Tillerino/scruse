...
public interface InjectionSerde {
	@JsonOutput
	void writeList(List<SelfReferencingRecord> list, JsonGenerator gen, InjectionSerializationContext ctx) throws IOException;

	@JsonOutput
	default void writeWithInjection(SelfReferencingRecord rec, JsonGenerator gen, InjectionSerializationContext ctx) throws IOException {
	...
	void writeInjectionRecord(SelfReferencingRecord rec, JsonGenerator gen, InjectionSerializationContext ctx) throws IOException;
	...
	/**
	 * NOCOPY
	 * This cannot be copied for the other backends because we need to access the generator directly.
	 */
	@JsonInput
	default SelfReferencingRecord readWithInjection(JsonParser parser, InjectionDeserializationContext ctx) throws IOException {
	...
	@JsonInput
	@JsonConfig(delegateTo = JsonConfig.DelegateeMode.DO_NOT_DELEGATE_TO)
	SelfReferencingRecord readInjectionRecord(JsonParser parser, InjectionDeserializationContext ctx) throws IOException;
}
