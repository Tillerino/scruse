...
public class InputUtils {
    ...
    public static <T> T assertIsEqualToDatabind(
            String json, FailableFunction<JsonNode, T, IOException> consumer, TypeReference<T> typeRef)
            throws IOException {
    ...
    public static <T, U> void assertIsEqualToDatabind2(
            String json, U arg2, FailableBiFunction<JsonNode, U, T, IOException> consumer, TypeReference<T> typeRef)
            throws IOException {
    ...
    public static <T> T deserialize(String json, FailableFunction<JsonNode, T, IOException> consumer)
            throws IOException {
        JsonNode parser = new ObjectMapper().readTree(json);
        return consumer.apply(parser);
    }

    public static <T, U> T deserialize2(String json, U obj2, FailableBiFunction<JsonNode, U, T, IOException> consumer)
            throws IOException {
        JsonNode parser = new ObjectMapper().readTree(json);
    ...
    public static <T> T assertIsEqualToDatabind(
            String json,
            FailableBiFunction<JsonNode, DeserializationContext, T, IOException> consumer,
